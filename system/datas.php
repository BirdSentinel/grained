...
$webdev_cards = array(
    ...
    array(
        ...
        "link"=>"https://github.com/birdsentinel/sports_template",
        "linkname"=>"Git repository"),
    array(
        "cardClass"=>"webdev",
        ...
        "link"=>"https://github.com/birdsentinel/donut_template",
        "linkname"=>"Git repository"),
    array(
        "cardClass"=>"webdev",
...
$games_cards = array(
    ...
    array(
        ...
        "title"=>"CandyVenture: Rebaked",
        "desc"=>"Bogyi and his friends count on you! Evil monsters invaded the candy world and stole all the candies. But you and our heroes are here to save their candy world! Use their powers to destroy the monsters in this cozy 2D adventure game!",
        "link"=>"https://store.steampowered.com/app/2723610/CandyVenture_Rebaked/",
        "linkname"=>"Check out on Steam!"),
    array(
        "cardClass"=>"game",
...
$other_cards = array(
    array(
        ...
        "link"=>"https://github.com/birdsentinel/keygenvibe",
        "linkname"=>"Git repository"),
    array(
        "cardClass"=>"other",
